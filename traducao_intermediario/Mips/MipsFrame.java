...
public class MipsFrame extends Frame {
    ...
    public Expr externalCall(String s, List<Expr> args) {
    ...
    /*
     * public List<Assem.Instr> codegen(List<Tree.Stm> stms) { List<Assem.Instr>
     * insns = new java.util.LinkedList<Assem.Instr>(); Codegen cg = new
     * Codegen(this, insns.listIterator()); for (java.util.Iterator<Tree.Stm> s =
     * stms.iterator(); s.hasNext(); ) s.next().accept(cg); return insns; }
     */
    ...
    private static MOVE MOVE(Expr d, Expr s) {
        return new MOVE(d, s);
    }
